...
class SocieteController extends AbstractController
{
     ...
     */
    public function onChangeSociete(Request $request, SocieteRepository $repo): Response
    {
        $data = [];
        $id = $request->request->get('conge')['societe'];

        $societe = $repo->findOneBy(['id' => $id]); 

        $workers = $societe->getWorkers();
